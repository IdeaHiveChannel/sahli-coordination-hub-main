export const en = {
  ...
  'nav.careChildcare': 'Care & Childcare (Soon)',
  'nav.lessonsLifestyle': 'Lessons & Lifestyle (Soon)',
  ...
  'services.homeMaintenance.electrical.items': 'Power Failure & Short Circuit\nSwitch, Socket & Light Fixing\nDB Box Maintenance\nLight & Fixture Installation',
  ...
  'services.homeMaintenance.pest.desc': 'Municipality-approved providers for bed bugs, cockroaches, ants, and termites.',
  'services.homeMaintenance.pest.items': 'Bed Bugs, Cockroaches, Ants, Termites\nMunicipality-approved Providers Only',

  'services.homeMaintenance.landscaping.title': 'Landscaping & Gardens',
  'services.homeMaintenance.landscaping.desc': 'Garden maintenance, irrigation repair, and lawn mowing.',
  'services.homeMaintenance.landscaping.items': 'Garden Maintenance\nIrrigation Repair\nLawn Mowing',

  'services.homeMaintenance.pool.title': 'Swimming Pool Services',
  'services.homeMaintenance.pool.desc': 'Pool cleaning, chemical balancing, and pump & filter repair.',
  'services.homeMaintenance.pool.items': 'Pool Cleaning\nChemical Balancing\nPump & Filter Repair',

  'services.homeMaintenance.waterproofing.title': 'Waterproofing',
  'services.homeMaintenance.waterproofing.desc': 'Roof leakage repair, damp proofing, and seepage control.',
  'services.homeMaintenance.waterproofing.items': 'Roof Leakage Repair\nDamp Proofing & Seepage Control',

  'services.homeMaintenance.appliances.title': 'Appliance Repair',
  'services.homeMaintenance.appliances.desc': 'Repair for washing machines, refrigerators, dishwashers, ovens, and microwaves.',
  'services.homeMaintenance.appliances.items': 'Washing Machines\nRefrigerators\nDishwashers\nOvens & Microwaves',

  'services.homeMaintenance.smarthome.title': 'Smart Home & Security',
  'services.homeMaintenance.smarthome.desc': 'CCTV installation, Wi-Fi extender setup, and smart locks.',
  'services.homeMaintenance.smarthome.items': 'CCTV Installation\nWi-Fi Extender Setup\nSmart Locks & Access Systems',

  'services.homeMaintenance.satellite.title': 'Satellite & TV',
  'services.homeMaintenance.satellite.desc': 'Dish alignment and IPTV & TV box setup.',
  'services.homeMaintenance.satellite.items': 'Dish Alignment\nIPTV & TV Box Setup',
  ...
  'services.moving.packing.desc': 'Professional packing and unpacking services for a stress-free move.',
  ...
  'services.care.childcare.path': '/babysitting-services-qatar',
  'services.care.body': 'Doctor visits, nursing, newborn care, elderly care, and professional childcare.',
  'services.care.rule': 'Soon to the SAHLI coordination network.',
  'services.care.cta': 'Coming Soon',
  'services.care.rules.title': 'Care Guidelines',
  'services.care.categories.title': 'Our Care Services',
  'services.care.categories.subtitle': 'Personalized for your family',
  ...
  'services.lessons.rule': 'Soon to the SAHLI coordination network.',
  'services.lessons.cta': 'Coming Soon',
  'services.lessons.rules.title': 'Service Guidelines',
  'services.lessons.categories.title': 'Our Educational Services',
  'services.lessons.categories.subtitle': 'Master Your Future',
  ...
  'services.lessons.music.items': 'Piano\nGuitar\nVocal Training\nTheory',
  ...
  'how.flow.subtitle': 'Seamless Coordination',
