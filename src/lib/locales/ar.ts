...
export const ar = {
  ...
  'services.moving.rules.title': 'قواعد الانتقال',
  'services.outdoor.rules.title': 'القواعد الخارجية',
  'services.electronics.rules.title': 'قواعد الإلكترونيات',
  'services.care.rules.title': 'قواعد الرعاية',
  'services.lessons.rules.title': 'قواعد الدروس',
  ...
  'services.homeMaintenance.ac.desc': 'إصلاح التكييف (لا يبرد، تسريب، ضجيج)، تعبئة الغاز، الصيانة وتنظيف القنوات، التركيب، ودعم الصيانة السنوية (عبر المزودين).',
  ...
  'services.cleaning.regular.desc': 'تنظيف دوري للمنازل والشقق والفلل، بما في ذلك تنسيق عاملات بنظام الساعات.',
  'services.cleaning.regular.items': 'تنظيف دوري للمنزل\nتنظيف الشقق والفيلات\nدعم عاملات بنظام الساعات',
  ...
  'services.electronics.rule': 'التنسيق مع مقدمي الخدمات باستخدام ممارسات التشخيص والتركيب المعتمدة.',
