...
export function Footer() {
  ...
  return (
    <footer className="bg-background border-t border-border pt-12 md:pt-16 pb-8 md:pb-10 relative overflow-hidden" dir={dir}>
      ...
      <div className="container-sahli relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 sm:gap-16 md:gap-20 lg:gap-8 mb-16 md:mb-24">
          ...
          <div className="lg:col-span-4 pr-0 lg:pr-8 flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <div className="relative w-[60px] h-[60px] sm:w-[70px] sm:h-[70px] md:w-[80px] md:h-[80px] flex items-center justify-center transition-all duration-700 ease-out-expo">
              <img 
            ...
            <p className="text-[10px] sm:text-[11px] md:text-xs text-muted-foreground leading-relaxed font-black mb-6 sm:mb-8 text-balance max-w-lg">
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-3 md:gap-4">
              <a
                ...
                className="w-10 sm:w-12 h-10 sm:h-12 rounded-xl bg-foreground/[0.03] hover:bg-primary/10 hover:text-primary transition-all duration-500 cursor-pointer flex items-center justify-center border border-border hover:border-primary/20 glass-card btn-shine active:scale-95 hover:-translate-y-1 hover:scale-105"
              >
            ...
            <ul className="space-y-4 sm:space-y-6 md:space-y-8">
              {links.company.map((link) => (
                <li key={link.key}>
                  <Link 
                    to={link.path} 
                    className="text-[10px] sm:text-[11px] md:text-xs font-bold text-muted-foreground hover:text-primary transition-all duration-500 flex items-center justify-center sm:justify-start gap-3 group active:scale-95"
                  >
            ...
            <ul className="space-y-4 sm:space-y-6">
              {links.locations.map((link) => (
                <li key={link.key}>
                  <Link 
                    to={link.path} 
                    className="text-[10px] md:text-[11px] font-bold text-muted-foreground hover:text-primary transition-all duration-500 flex items-center justify-center sm:justify-start gap-3 group active:scale-95"
                  >
          ...
          <div className="lg:col-span-4 lg:pt-8 text-center sm:text-left">
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              <a
                ...
                className="flex items-center gap-4 md:gap-5 p-4 sm:p-5 rounded-[2rem] sm:rounded-3xl bg-foreground/[0.02] border border-border hover:border-primary/20 transition-all duration-500 group glass-card btn-shine active:scale-95 hover:scale-[1.02] hover:-translate-y-1"
              >
                <div
                ...
                >
                  ...
                  <div className="min-w-0 flex flex-col justify-center text-left">
                    <span className="block text-[9px] md:text-[10px] font-black uppercase tracking-[0.25em] text-muted-foreground leading-tight mb-1.5">{t('footer.whatsapp')}</span>
              ...
              >
                ...
                <div className="min-w-0 flex flex-col justify-center text-left">
                  <span className="block text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground leading-tight mb-1.5">{t('contact.email.label')}</span>
        ...
        <div className="pt-8 md:pt-12 border-t border-border flex flex-col lg:flex-row justify-between items-center gap-8 sm:gap-10">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-[9px] md:text-[10px] font-black tracking-[0.2em] uppercase text-muted-foreground text-center lg:text-left">
                {t('footer.positioning')}
              </p>
              <p className="text-[9px] md:text-[10px] font-black tracking-[0.3em] uppercase text-muted-foreground text-center lg:text-left">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-16">
            <Link to="/legal/privacy" className="text-[9px] md:text-[10px] font-black tracking-[0.3em] uppercase text-muted-foreground hover:text-primary transition-colors active:scale-95">
              {t('footer.privacy')}
            </Link>
