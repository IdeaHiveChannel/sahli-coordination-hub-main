...
export default function Doha() {
  ...
  return (
    <Layout>
      <MetaTags 
        title="Home Services in Doha | SAHLI Coordination Hub"
        description="Verified home maintenance, cleaning, and specialized services across Doha's premier neighborhoods. One hub for all your requirements."
      />
        ...
        <div className="container-sahli relative z-10 text-center max-w-2xl mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black mb-6 text-foreground">
              Ready to coordinate in Doha?
            </h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Message SAHLI on WhatsApp for verified home services in Doha and West Bay.
            </p>
