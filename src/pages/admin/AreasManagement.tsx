        ...
        <div className="flex items-center justify-between mb-6 bg-white/50 backdrop-blur-md p-4 rounded-xl border border-primary/10 shadow-sm">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Badge variant="outline" className="bg-primary/10 text-primary border-primary/20 font-black tracking-widest text-[10px]">MANAGEMENT</Badge>
              <Badge variant="outline" className="bg-emerald-50 text-emerald-600 border-emerald-100 font-bold text-[10px]">{areas.length} ACTIVE AREAS</Badge>
            </div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-900">Areas Management</h1>
            <p className="text-xs text-muted-foreground mt-1">
              Manage geographic service coverage zones across Qatar.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          <Card className="lg:col-span-1 border-primary/10 shadow-md bg-white/80 backdrop-blur-sm h-fit">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-[10px]">Enter a new region to include in service coverage.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              />
              <Button onClick={handleAddArea} className="w-full bg-slate-900 hover:bg-slate-800 font-bold">Register Area</Button>
            </CardContent>
          </Card>
          ...
          <Card className="lg:col-span-3 border-primary/10 shadow-md bg-white/80 backdrop-blur-sm overflow-hidden">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4 border-b border-slate-100/50">
              <div>
                ...
                <CardDescription className="text-xs">Geographic locations where SAHLI providers operate.</CardDescription>
              </div>
                  ...
                  <div className="col-span-full py-12 text-center">
                    <div className="flex flex-col items-center justify-center text-slate-400">
                      ...
                      <p className="text-sm font-medium">
                        {searchQuery ? `No areas matching "${searchQuery}"` : 'No areas defined yet.'}
                      </p>
                    </div>
                  </div>
                )}
