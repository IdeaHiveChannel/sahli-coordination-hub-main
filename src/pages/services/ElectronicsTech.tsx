...
import { MessageCircle, CheckCircle2, Tv, ShieldCheck, Smartphone, Cog, Wrench, Shield, Clock, MapPin, AlertCircle, ArrowUp } from 'lucide-react';
          ...
          >
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <motion.a
                ...
                onClick={() => trackWhatsAppClick('Electronics Hero CTA')}
      ...
      <section className="section-spacing bg-background relative overflow-hidden">
        <div className="container-sahli">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-foreground/50 font-bold text-lg uppercase tracking-widest">{t('services.electronics.categories.subtitle')}</p>
          </div>
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackWhatsAppClick('Electronics Final CTA')}
