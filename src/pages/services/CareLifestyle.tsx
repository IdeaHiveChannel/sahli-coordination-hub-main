...
import { CheckCircle2, MessageSquare, Heart, Baby, Stethoscope, Users, Sparkles, ShieldCheck, Clock, AlertCircle, MapPin, ArrowUp, Search, Zap, Home, Shield } from 'lucide-react';
...
export default function CareLifestyle() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "Care & Lifestyle Services Qatar",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": t('services.care.problem'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.care.problem.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.care.why'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.care.why.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.care.inspection'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.care.inspection.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.care.pricing'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.care.pricing.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.care.availability'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.care.availability.desc')
          }
        }
      ]
    }
    ...
    <Layout>
      ...
      <div className="relative min-h-[60vh] flex flex-col items-center justify-center text-center py-24 px-4 z-50 bg-background/50 backdrop-blur-sm border-b border-border">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mb-10 font-medium leading-relaxed">
          We are currently enhancing our Care & Lifestyle services to serve you better.
          <br />
      ...
      <section ref={containerRef} className="relative min-h-[85vh] md:min-h-[90vh] max-h-[1000px] flex flex-col justify-center md:justify-end overflow-hidden bg-background">
        ...
        <div className="container-sahli relative z-20 pt-16 pb-12 md:pb-20 flex flex-col items-center md:items-start">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 md:mb-8 leading-[1.1] tracking-tight text-foreground drop-shadow-2xl font-black w-full text-center md:text-start animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 fill-mode-backwards">
              {t('services.care.title')}
            </h1>
      ...
      <section className="section-spacing bg-muted/30 border-y border-border">
        <div className="container-sahli">
          <ScrollReveal 
            className="bg-background border border-border rounded-xl p-4 md:p-5 shadow-sm shadow-primary/5"
          >
            ...
            <div className="space-y-8 md:space-y-12">
              <ScrollReveal>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-2 text-foreground">{t('services.care.problem')}</h3>
                    <p className="text-muted-foreground text-sm leading-relaxed">{t('services.care.problem.desc')}</p>
                  </div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.1}>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-2 text-foreground">{t('services.care.why')}</h3>
                    <p className="text-muted-foreground text-sm leading-relaxed">{t('services.care.why.desc')}</p>
                  </div>
                </div>
              </ScrollReveal>
            </div>
            ...
            <div className="space-y-8 md:space-y-12">
              <ScrollReveal delay={0.2}>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-2 text-foreground">{t('services.care.inspection')}</h3>
                    <p className="text-muted-foreground text-sm leading-relaxed">{t('services.care.inspection.desc')}</p>
                  </div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-2 text-foreground">{t('services.care.pricing')}</h3>
                    <p className="text-muted-foreground text-sm leading-relaxed">{t('services.care.pricing.desc')}</p>
                  </div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.4}>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-2 text-foreground">{t('services.care.availability')}</h3>
                    <p className="text-muted-foreground text-sm leading-relaxed">{t('services.care.availability.desc')}</p>
                  </div>
                </div>
              </ScrollReveal>
            </div>
      ...
      <section className="section-spacing bg-background relative overflow-hidden">
        <div className="container-sahli">
          <div className="text-center max-w-2xl mx-auto mb-10 md:mb-12">
            ...
            <p className="text-xs text-muted-foreground">{t('services.care.categories.subtitle')}</p>
          </div>
          ...
          <Marquee speed={0.4} className="-mx-4 px-4" gap={16}>
            {categories.map((cat, i) => (
              <ScrollReveal
                key={i}
                delay={i * 0.05}
                className="group p-5 md:p-6 rounded-xl bg-muted/30 border border-border hover:border-primary/40 hover:bg-muted/50 transition-all duration-500 shrink-0 w-[220px] md:w-auto shadow-sm shadow-primary/5"
              >
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-3 group-hover:scale-110 group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-500 shadow-sm group-hover:shadow-primary/20">
