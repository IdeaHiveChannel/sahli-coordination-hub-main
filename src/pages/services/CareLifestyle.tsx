...
import { CheckCircle2, MessageCircle, Heart, Baby, Stethoscope, Users, Sparkles, ShieldCheck, Clock, AlertCircle, MapPin, ArrowUp, GraduationCap } from 'lucide-react';
          ...
          >
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <motion.a
                ...
                onClick={() => trackWhatsAppClick('Care Hero CTA')}
            ...
            <div className="absolute bottom-8 left-8 right-8 p-6 rounded-2xl bg-background/80 backdrop-blur-md border border-white/10 shadow-2xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-foreground font-bold">{t('services.care.compassionateCare')}</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackWhatsAppClick('Care Final CTA')}
