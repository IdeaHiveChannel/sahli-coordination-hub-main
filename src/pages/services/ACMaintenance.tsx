...
import { MessageSquare, CheckCircle2, Snowflake, ArrowUp, AlertCircle, Search, Clock, MapPin, Phone, ShieldCheck, Wrench } from 'lucide-react';
...
export default function ACMaintenance() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "AC Maintenance Qatar",
    "description": t('services.ac.maintenance.hero.title'),
    "provider": {
      "@type": "LocalBusiness",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": t('services.ac.maintenance.problem'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.maintenance.problem.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.ac.maintenance.why'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.maintenance.why.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.ac.maintenance.inspection'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.maintenance.inspection.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.ac.maintenance.pricing'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.maintenance.pricing.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.ac.maintenance.availability'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.maintenance.availability.desc')
          }
        }
      ]
    }
  ...
  const excludes = [
    ...
    'Gas Refill (if leak exists)'
  ];

  const areas = [
    'Doha', 'Al Rayyan', 'Lusail', 'Al Wakrah', 'The Pearl', 'West Bay', 'Al Khor', 'Umm Salal'
  ];

  const features = [
    {
      title: "Preventive Care",
      description: "Regular maintenance prevents major breakdowns and extends unit life.",
      icon: <ShieldCheck className="w-6 h-6 text-primary" />,
      image: "/Services/AC Maintenance.jpg"
    },
    {
      title: "Performance Boost",
      description: "Clean filters and coils ensure optimal cooling efficiency and lower bills.",
      icon: <ArrowUp className="w-6 h-6 text-primary" />,
      image: "https://images.pexels.com/photos/1335077/pexels-photo-1335077.jpeg"
    },
    {
      title: "Air Quality",
      description: "Remove dust, mold, and allergens for healthier indoor air quality.",
  ...
  const steps = [
    {
      title: t('services.ac.inspection'),
      desc: "Comprehensive check of all AC components.",
      icon: <Search size={24} />
    },
    {
      title: "Cleaning",
      desc: "Deep cleaning of filters, coils, and drains.",
      icon: <CheckCircle2 size={24} />
    },
    {
      title: "Testing",
      desc: "Final performance test to ensure optimal cooling.",
      icon: <Wrench size={24} />
    }
  ];
  ...
  return (
    <Layout>
      <MetaTags 
        title={t('services.ac.maintenance.hero.title')} 
        description={t('services.ac.maintenance.problem.desc')} 
        schema={schema} 
      />
      
      <div className="relative min-h-[60vh] flex flex-col items-center justify-center text-center py-24 px-4 z-50 bg-background/50 backdrop-blur-sm border-b border-border">
        <div className="w-24 h-24 bg-primary/10 rounded-3xl flex items-center justify-center mb-8 text-primary animate-pulse shadow-2xl shadow-primary/20">
          <Clock size={48} />
        </div>
        <h1 className="text-5xl md:text-7xl font-black text-foreground mb-6 tracking-tight">
          Coming Soon
        </h1>
        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mb-10 font-medium leading-relaxed">
          We are currently enhancing our AC Maintenance services to serve you better.
          <br />
          <span className="text-primary font-bold">Stay tuned!</span>
        </p>
        <Link to="/services" className="inline-flex items-center gap-3 px-10 py-5 bg-primary text-primary-foreground rounded-2xl font-bold text-lg hover:bg-primary/90 transition-all shadow-xl shadow-primary/25 hover:scale-105">
          Explore Other Services
        </Link>
      </div>

      <div className="opacity-20 grayscale pointer-events-none select-none filter blur-[2px]">
          ...
          <div className="max-w-4xl">
            <ScrollReveal>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-10 font-medium leading-relaxed max-w-2xl text-balance">
                {t('services.ac.maintenance.hero.subtitle')}
              </p>
        ...
        <div className="container-sahli relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={0.1} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-red-500/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.ac.maintenance.problem')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.ac.maintenance.problem.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2} className="p-6 md:p-8 rounded-2xl bg-secondary text-secondary-foreground shadow-xl transform md:-translate-y-4">
              ...
              <h3 className="text-xl font-bold mb-3">{t('services.ac.maintenance.inspection')}</h3>
              <p className="text-sm text-secondary-foreground/80 leading-relaxed">{t('services.ac.maintenance.inspection.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.ac.maintenance.availability')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.ac.maintenance.availability.desc')}</p>
            </ScrollReveal>
      ...
      <section className="section-spacing bg-background relative overflow-hidden">
        <div className="container-sahli">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-sm text-muted-foreground">{t('services.ac.maintenance.hero.title')} Services</p>
          </div>

          <Marquee speed={0.5} pauseOnHover={true} className="py-4">
            {includes.map((item, i) => (
              <div
                key={i}
                className="group relative p-5 md:p-6 rounded-xl bg-card border border-border hover:border-primary/50 transition-all duration-500 shadow-sm hover:shadow-xl hover:shadow-primary/5 mx-4 w-[250px]"
              >
                ...
                <h3 className="text-xs mb-2 group-hover:text-primary transition-colors font-bold uppercase tracking-wider text-foreground">{item}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {steps.map((step, i) => (
              ...
              >
                ...
                <p className="text-xs px-2 font-medium text-muted-foreground group-hover:text-primary transition-colors duration-500 leading-tight">{step.desc}</p>
              </ScrollReveal>
            ))}
          </div>
        </div>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackRequestClick('AC Maintenance Bottom CTA')}
                className="w-full sm:w-auto px-8 py-4 bg-primary text-white rounded-xl font-bold text-lg hover:bg-primary-dark transition-all duration-300 shadow-lg shadow-primary/25 hover:shadow-primary/40 flex items-center justify-center gap-3 group"
              >
                <div
