...
export default function ElectricianDoha() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "Electrician in Doha",
    "description": t('services.electrician.doha.desc'),
    "provider": {
      "@type": "LocalBusiness",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": t('services.electrician.doha.problem.title'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electrician.doha.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.electrician.doha.why'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electrician.doha.why.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.electrician.doha.inspection'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electrician.doha.inspection.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.electrician.doha.pricing'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electrician.doha.pricing.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.electrician.doha.availability'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electrician.doha.availability.desc')
          }
        }
      ]
    }
  ...
  return (
    <Layout>
      <MetaTags 
        title={`${t('services.electrician.doha.title')} | SAHLI`}
        description={t('services.electrician.doha.desc')}
        schema={schema}
      />
          ...
          <div className="max-w-4xl">
            <ScrollReveal>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-foreground mb-6 leading-tight tracking-tight">
                {t('services.electrician.doha.title')}
              </h1>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-10 font-medium leading-relaxed max-w-2xl text-balance">
                {t('services.electrician.doha.subtitle')}
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <a
                  ...
                  onClick={() => trackRequestClick('Electrician Doha Hero')}
                ...
                <div className="w-full sm:w-auto px-8 py-4 bg-background/10 backdrop-blur-md text-foreground rounded-xl font-bold border border-foreground/10 flex items-center justify-center gap-2">
                  ...
                  <span>{t('services.electrician.doha.response.desc')}</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container-sahli relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={0.1} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-red-500/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.electrician.doha.problem.title')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.electrician.doha.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2} className="p-6 md:p-8 rounded-2xl bg-secondary text-secondary-foreground shadow-xl transform md:-translate-y-4">
              ...
              <h3 className="text-xl font-bold mb-3">{t('services.electrician.doha.inspection')}</h3>
              <p className="text-sm text-secondary-foreground/80 leading-relaxed">{t('services.electrician.doha.inspection.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.electrician.doha.availability')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.electrician.doha.availability.desc')}</p>
            </ScrollReveal>
          ...
          <ScrollReveal>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackRequestClick('Electrician Doha Final CTA')}
