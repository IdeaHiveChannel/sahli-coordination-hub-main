...
export default function CleaningLusail() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "Cleaning Services in Lusail",
    "description": t('services.cleaning.lusail.desc'),
    "provider": {
      "@type": "LocalBusiness",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": t('services.cleaning.lusail.problem.title'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.lusail.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.cleaning.lusail.why'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.lusail.why.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.cleaning.lusail.inspection'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.lusail.inspection.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.cleaning.lusail.pricing'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.lusail.pricing.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.cleaning.lusail.availability'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.lusail.availability.desc')
          }
        }
      ]
    }
  ...
  const areas = ['Fox Hills', 'Marina District', 'Waterfront', 'Erkyah City', 'Energy City', 'Al Tarfa'];
  ...
  return (
    <Layout>
      <MetaTags 
        title={`${t('services.cleaning.lusail.title')} | SAHLI`}
        description={t('services.cleaning.lusail.desc')}
        schema={schema}
      />
      ...
      <section ref={containerRef} className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden bg-background">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0">
            <img 
              src="/Services/Cleaning - Hero.jpg" 
              alt="Cleaning Services in Lusail"
          ...
          <div className="max-w-4xl">
            <ScrollReveal>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-10 font-medium leading-relaxed max-w-2xl text-balance">
                {t('services.cleaning.lusail.subtitle')}
              </p>

              <div className="flex flex-col sm:flex-row items-center gap-4">
                <a
                  href={getWhatsAppLink(t('services.cleaning.whatsapp') || 'I need cleaning services')}
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackRequestClick('Cleaning Lusail Hero')}
                ...
                <div className="w-full sm:w-auto px-8 py-4 bg-background/10 backdrop-blur-md text-foreground rounded-xl font-bold border border-foreground/10 flex items-center justify-center gap-2">
                  ...
                  <span>{t('services.cleaning.lusail.response.desc')}</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container-sahli relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={0.1} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-red-500/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.cleaning.lusail.problem.title')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.cleaning.lusail.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2} className="p-6 md:p-8 rounded-2xl bg-secondary text-secondary-foreground shadow-xl transform md:-translate-y-4">
              ...
              <h3 className="text-xl font-bold mb-3">{t('services.cleaning.lusail.inspection')}</h3>
              <p className="text-sm text-secondary-foreground/80 leading-relaxed">{t('services.cleaning.lusail.inspection.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.cleaning.lusail.availability')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.cleaning.lusail.availability.desc')}</p>
            </ScrollReveal>
          ...
          <ScrollReveal>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackRequestClick('Cleaning Lusail Final CTA')}
