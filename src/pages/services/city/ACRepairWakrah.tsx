...
import { MessageSquare, Clock, MapPin, AlertCircle, Search, CheckCircle2, Snowflake, ArrowUp, HelpCircle, Shield, ShieldCheck } from 'lucide-react';
import { trackRequestClick } from '@/lib/gtag';
import { Link } from 'react-router-dom';
import { getWhatsAppLink } from '@/lib/constants';
import { MetaTags } from '@/components/seo/MetaTags';

export default function ACRepairWakrah() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "AC Repair Al Wakrah",
    "description": t('services.ac.wakrah.desc'),
    "provider": {
      "@type": "LocalBusiness",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": t('services.ac.wakrah.problem.title'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.wakrah.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.ac.wakrah.why'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.wakrah.why.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.ac.wakrah.inspection'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.wakrah.inspection.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.ac.wakrah.pricing'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.wakrah.pricing.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.ac.wakrah.availability'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.ac.wakrah.availability.desc')
          }
        }
      ]
    }
  ...
  return (
    <Layout>
      <MetaTags 
        title={`${t('services.ac.wakrah.title')} | SAHLI`}
        description={t('services.ac.wakrah.desc')}
        schema={schema}
      />
          ...
          <div className="max-w-4xl">
            <ScrollReveal>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-10 font-medium leading-relaxed max-w-2xl text-balance">
                {t('services.ac.wakrah.subtitle')}
              </p>

              <div className="flex flex-col sm:flex-row items-center gap-4">
                <a
                  href={getWhatsAppLink(t('services.homeMaintenance.ac.whatsapp') || 'I need AC repair')}
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackRequestClick('AC Wakrah Hero')}
                ...
                <div className="w-full sm:w-auto px-8 py-4 bg-background/10 backdrop-blur-md text-foreground rounded-xl font-bold border border-foreground/10 flex items-center justify-center gap-2">
                  ...
                  <span>{t('services.ac.wakrah.response.desc')}</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
      ...
      {/* 2️⃣ Local Context & SEO Block (Problems & Diagnostics Style) */}
        ...
        <div className="container-sahli relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={0.1} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-red-500/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.ac.wakrah.problem.title')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.ac.wakrah.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2} className="p-6 md:p-8 rounded-2xl bg-secondary text-secondary-foreground shadow-xl transform md:-translate-y-4">
              ...
              <h3 className="text-xl font-bold mb-3">{t('services.ac.wakrah.inspection')}</h3>
              <p className="text-sm text-secondary-foreground/80 leading-relaxed">{t('services.ac.wakrah.inspection.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.ac.wakrah.availability')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.ac.wakrah.availability.desc')}</p>
            </ScrollReveal>
          ...
          <ScrollReveal>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackRequestClick('AC Wakrah Final CTA')}
      ...
      {/* 7️⃣ Related Services - Quick Links */}
