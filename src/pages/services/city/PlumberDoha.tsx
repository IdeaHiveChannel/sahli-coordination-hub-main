...
export default function PlumberDoha() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "Plumber in Doha",
    "description": t('services.plumber.doha.desc'),
    "provider": {
      "@type": "LocalBusiness",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": t('services.plumber.doha.problem.title'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.plumber.doha.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.plumber.doha.why'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.plumber.doha.why.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.plumber.doha.inspection'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.plumber.doha.inspection.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.plumber.doha.pricing'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.plumber.doha.pricing.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.plumber.doha.availability'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.plumber.doha.availability.desc')
          }
        }
      ]
    }
  ...
  return (
    <Layout>
      <MetaTags 
        title={`${t('services.plumber.doha.title')} | SAHLI`}
        description={t('services.plumber.doha.desc')}
        schema={schema}
      />
          ...
          <div className="max-w-4xl">
            <ScrollReveal>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-10 font-medium leading-relaxed max-w-2xl text-balance">
                {t('services.plumber.doha.subtitle')}
              </p>

              <div className="flex flex-col sm:flex-row items-center gap-4">
                <a
                  href={getWhatsAppLink(t('services.homeMaintenance.plumbing.whatsapp') || 'I need a plumber')}
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackRequestClick('Plumber Doha Hero')}
                ...
                <div className="w-full sm:w-auto px-8 py-4 bg-background/10 backdrop-blur-md text-foreground rounded-xl font-bold border border-foreground/10 flex items-center justify-center gap-2">
                  ...
                  <span>{t('services.plumber.doha.response.desc')}</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container-sahli relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={0.1} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-red-500/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.plumber.doha.problem.title')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.plumber.doha.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2} className="p-6 md:p-8 rounded-2xl bg-secondary text-secondary-foreground shadow-xl transform md:-translate-y-4">
              ...
              <h3 className="text-xl font-bold mb-3">{t('services.plumber.doha.inspection')}</h3>
              <p className="text-sm text-secondary-foreground/80 leading-relaxed">{t('services.plumber.doha.inspection.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.plumber.doha.availability')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.plumber.doha.availability.desc')}</p>
            </ScrollReveal>
          ...
          <ScrollReveal>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackRequestClick('Plumber Doha Final CTA')}
