...
export default function CleaningDoha() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "Cleaning Services in Doha",
    "description": t('services.cleaning.doha.desc'),
    "provider": {
      "@type": "LocalBusiness",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": t('services.cleaning.doha.problem.title'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.doha.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.cleaning.doha.why'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.doha.why.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.cleaning.doha.inspection'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.doha.inspection.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.cleaning.doha.pricing'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.doha.pricing.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.cleaning.doha.availability'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.cleaning.doha.availability.desc')
          }
        }
      ]
    }
  ...
  const areas = [
    'West Bay', 'The Pearl', 'Al Sadd', 'Bin Mahmoud', 'Madinat Khalifa', 'Old Airport', 'Al Thumama',
    t('home.areas.item1'),
    t('home.areas.item2')
  ];
  ...
  return (
    <Layout>
      <MetaTags 
        title={`${t('services.cleaning.doha.title')} | SAHLI`}
        description={t('services.cleaning.doha.desc')}
        schema={schema}
      />
          ...
          <div className="max-w-4xl">
            <ScrollReveal>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-foreground mb-6 leading-tight tracking-tight">
                {t('services.cleaning.doha.title')}
              </h1>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-10 font-medium leading-relaxed max-w-2xl text-balance">
                {t('services.cleaning.doha.subtitle')}
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <a
                  ...
                  onClick={() => trackRequestClick('Cleaning Doha Hero')}
                ...
                <div className="w-full sm:w-auto px-8 py-4 bg-background/10 backdrop-blur-md text-foreground rounded-xl font-bold border border-foreground/10 flex items-center justify-center gap-2">
                  ...
                  <span>{t('services.cleaning.doha.response.desc')}</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container-sahli relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={0.1} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-red-500/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.cleaning.doha.problem.title')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.cleaning.doha.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2} className="p-6 md:p-8 rounded-2xl bg-secondary text-secondary-foreground shadow-xl transform md:-translate-y-4">
              ...
              <h3 className="text-xl font-bold mb-3">{t('services.cleaning.doha.inspection')}</h3>
              <p className="text-sm text-secondary-foreground/80 leading-relaxed">{t('services.cleaning.doha.inspection.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3} className="p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-foreground">{t('services.cleaning.doha.availability')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.cleaning.doha.availability.desc')}</p>
            </ScrollReveal>

            {/* 4️⃣ Boundary Block */}
            <section className="section-spacing bg-background col-span-1 md:col-span-2 lg:col-span-3">
          ...
          <ScrollReveal>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackRequestClick('Cleaning Doha Final CTA')}
