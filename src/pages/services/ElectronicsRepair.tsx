...
export default function ElectronicsRepair() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": t('services.electronics.title'),
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": t('services.electronics.problem'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electronics.problem.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.electronics.why'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electronics.why.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.electronics.inspection'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electronics.inspection.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.electronics.pricing'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electronics.pricing.desc')
          }
        },
        {
          "@type": "Question",
          "name": t('services.electronics.availability'),
          "acceptedAnswer": {
            "@type": "Answer",
            "text": t('services.electronics.availability.desc')
          }
        }
      ]
    }
    ...
    <Layout>
      ...
      <div className="relative min-h-[60vh] flex flex-col items-center justify-center text-center py-24 px-4 z-50 bg-background/50 backdrop-blur-sm border-b border-border">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mb-10 font-medium leading-relaxed">
          We are currently enhancing our Electronics Repair services to serve you better.
          <br />
      ...
      {/* 2️⃣ Problems & Diagnostics Block */}
        ...
        <div className="container-sahli relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={0.1} className="p-6 md:p-8 rounded-2xl bg-background border border-border hover:border-red-200 hover:shadow-xl hover:shadow-red-500/5 transition-all duration-300 group">
              ...
              <h3 className="text-lg font-bold mb-3 text-foreground">{t('services.electronics.problem')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed mb-6">{t('services.electronics.problem.desc')}</p>
              ...
              <div className="flex items-start gap-3 pt-6 border-t border-border">
                ...
                <div>
                  <span className="block text-xs font-bold text-foreground mb-1">{t('services.electronics.why')}</span>
                  <p className="text-xs text-muted-foreground">{t('services.electronics.why.desc')}</p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2} className="p-6 md:p-8 rounded-2xl bg-card text-card-foreground shadow-2xl shadow-primary/5 transform md:-translate-y-4 border border-border">
              ...
              <h3 className="text-lg font-bold mb-3">{t('services.electronics.inspection')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.electronics.inspection.desc')}</p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3} className="p-6 md:p-8 rounded-2xl bg-background border border-border hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 group">
              ...
              <h3 className="text-lg font-bold mb-3 text-foreground">{t('services.electronics.pricing')}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">{t('services.electronics.pricing.desc')}</p>
            </ScrollReveal>
          </div>
        </div>
      </section>
      ...
      <section className="section-spacing bg-background relative overflow-hidden">
        <div className="container-sahli">
          <div className="text-center max-w-2xl mx-auto mb-10 md:mb-12">
            ...
            <p className="text-xs text-muted-foreground">{t('services.electronics.categories.subtitle')}</p>
          </div>
          ...
          <Marquee speed={0.4} className="-mx-4 px-4" gap={16}>
            {categories.map((cat, i) => (
              <ScrollReveal
                key={i}
                delay={i * 0.05}
                className="p-5 md:p-6 rounded-xl bg-muted/30 border border-border hover:border-primary/20 transition-all duration-500 group shrink-0 w-[240px] md:w-auto shadow-xl shadow-primary/5"
              >
        ...
        <div className="container-sahli relative z-10">
          ...
          <Marquee speed={0.4} className="-mx-4 px-4" gap={32}>
            {coordinationSteps.map((step, i) => (
              ...
              >
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-background border border-border flex items-center justify-center text-primary mb-5 md:mb-6 shadow-xl group-hover:border-primary/50 group-hover:shadow-primary/10 transition-all duration-500 shadow-primary/5">
        ...
        <div className="container-sahli">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <ul className="space-y-3">
                {t('services.boundaries.is.body').split('\n').map((item: string, i: number) => (
                  <li key={i} className="flex gap-4 items-center text-xs text-muted-foreground font-medium">
            ...
            <ScrollReveal
              ...
              className="p-5 md:p-6 rounded-xl bg-muted/30 border border-border shadow-xl shadow-primary/5"
            >
              <h3 className="text-xs text-muted-foreground mb-5 font-bold">
      ...
      <section className="section-spacing bg-background overflow-hidden">
        <div className="container-sahli">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <Marquee speed={0.4} className="-mx-4 px-4" gap={12}>
                {areas.map((area, i) => (
                  <ScrollReveal
                    ...
                    direction={dir === 'rtl' ? 'left' : 'right'}
                    delay={i * 0.1}
                    className="flex items-center gap-3 p-4 rounded-xl bg-muted/30 border border-border hover:border-primary/30 transition-all group shrink-0 w-[180px] md:w-auto shadow-xl shadow-primary/5"
                  >
            ...
            <div className="relative aspect-video md:aspect-[2/1] rounded-xl overflow-hidden border border-border bg-muted/30 flex items-center justify-center">
