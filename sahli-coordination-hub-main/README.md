...
- `src/components`: Reusable UI components and motion-enhanced elements.
- `src/contexts`: React Context providers (e.g., LanguageContext).
- `src/hooks`: Custom React hooks.
- `src/lib`: Utility functions and i18n configurations.
- `src/pages`: Application pages and service-specific views.
